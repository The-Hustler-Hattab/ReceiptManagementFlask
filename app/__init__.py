...
class Constants:
    ...
    BLOB_CONTAINER_SHERIF_SALE_CONNECTION_STRING='BLOB_CONTAINER_SHERIF_SALE_CONNECTION_STRING'
...
app.config[Constants.BLOB_CONTAINER_SHERIF_SALE_CONNECTION_STRING] = os.getenv(Constants.BLOB_CONTAINER_SHERIF_SALE_CONNECTION_STRING)
